...
class CreateBooking(BaseModel):
    ...
    check_in: date = Field(..., description="Дата начала бронирования")
    check_out: date = Field(..., description="Дата окончания бронирования")


class UpdateBooking(BaseModel):
    check_in: Optional[date] = Field(None, description="Дата начала бронирования")
    check_out: Optional[date] = Field(None, description="Дата окончания бронирования")
